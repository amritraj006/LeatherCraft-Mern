...
router.get('/marketplace/products', auth, async (req, res) => {
  try {
...
router.post('/marketplace/products', auth, async (req, res) => {
  try {
...
router.post('/marketplace/products/:productId/purchase', auth, async (req, res) => {
  try {
...
router.put('/marketplace/products/:productId', auth, async (req, res) => {
  try {
