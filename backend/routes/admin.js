...
router.get('/admin/pending-products', auth, adminOnly, async (req, res) => {
  try {
...
router.patch('/admin/products/:productId/status', auth, adminOnly, async (req, res) => {
  try {
...
router.get('/admin/sellers', auth, adminOnly, async (req, res) => {
  try {
...
router.get('/admin/sellers/:sellerId/designs', auth, adminOnly, async (req, res) => {
  try {
...
router.get('/admin/sales', auth, adminOnly, async (req, res) => {
  try {
...
router.patch('/admin/sales/:saleId/status', auth, adminOnly, async (req, res) => {
  try {
    const { status } = req.body;
